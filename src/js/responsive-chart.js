//for reference: https://gist.github.com/chrtze/e5ddec8d476335d79bbc and http://blog.webkid.io/responsive-chart-usability-d3/

// var Chart = (function(window, d3) {
//   //create some variables to play with
//   var chart, data, x, y, xAxis, yAxis, dim, chartWrapper, line, path, margin = {}, width, height;
//
//   //init data
...
//     yExtent = d3.extent(data, function(d, i) { return d.close });
...
//     //init svg
//     chart = d3.select('.responsive-chart').append('svg');
...
//
//   function render() {
//     //get dim based on window size
//     updateDimensions(window.innerWidth);
//     //update scales to new values
//     x.range([0, width]);
//     y.range([height, 0]);
//     //update svg elements
...
var Chart = (function(window,d3) {
  ...
  function init(csv) {
    ...
    path = chartWrapper.append('path').classed('line', true).attr('d', line(data));
